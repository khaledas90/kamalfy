...
import { PermissionsProvider, Screens } from "@/components/permissions/ScreensPermissionsContext";
import Header from "./_components/Layout/Header";

interface ClientProps {
  children: React.ReactNode;
  screens: Permission | null;
}
...
export default function Client({ children, screens }: ClientProps) {
  ...
  return (
    <PermissionsProvider
      permissions={(screens?.screens as unknown) as Screens | null}
