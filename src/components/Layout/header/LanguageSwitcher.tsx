...
const LanguageSwitcher = ({ isFooter }: { isFooter?: boolean }) => {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      <div
        className={`absolute z-40 top-full mt-2 w-36 border left-0 border-gray-200/50 shadow-2xl bg-white overflow-hidden transition-all duration-300 ease-out ${
          isOpen
        ...
        style={{
          // top: isFooter ? "-85px" : "",
          left: isFooter ? (currentLang === "ar" ? "15px" : "-20px") : "-20px",
        }}
      >
